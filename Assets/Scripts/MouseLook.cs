...
public class MouseLook
{
    ...
    public void LookRotation(Transform character, Transform camera)
    {
        ...
        if (smooth)
        {
            character.localRotation = Quaternion.Slerp(character.localRotation, _characterTargetRotation,
                smoothTime * Time.deltaTime);
            camera.localRotation = Quaternion.Slerp(camera.localRotation, _cameraTargetRotation,
                smoothTime * Time.deltaTime);
        }
        else
        {
